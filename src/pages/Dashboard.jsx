          ...
          <div key={section.id} className="mb-8">
            ...
            {section.trainings.length > 0 ? (
              <div className="overflow-x-auto pb-4 md:overflow-visible">
                <div className="flex gap-6 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-6">
                  {section.trainings.map((training, trainingIndex) => (
                    <div
                      key={training.id}
                      className="bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:shadow-xl flex-shrink-0 w-80 md:w-auto flex flex-col aspect-[3/4]"
